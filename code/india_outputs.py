...
<div class=callout><b>Correction carried prominently — and corrected again (v0.7.4).</b> An earlier draft of this work stated that no South-Asian antivenom products were in WHO's risk-benefit assessment. <b>That was wrong:</b> eight are listed by WHO as <i>undergoing</i> risk-benefit assessment for South Asia (Bharat Serums, Biological E ×2, Haffkine, NIH Pakistan, Premium Serums ×2, VINS). Our first correction (July 2026) said "seven are WHO risk-benefit-assessed" — wrong twice: it omitted NIH Pakistan, and it over-stated the status. As of 5 September 2026 <b>none of the eight has a final WHO outcome</b>; under this project's own grading, "in the process" is not grade A. We correct it here rather than quietly drop it, and note that both errors ran in the manufacturers' favour. The finding survives either way, because it never depended on it: WHO assessment covers the <b>Big-Four label</b>, and does not certify performance against <b>regional venom variation</b> within those four species, nor against the ~20 medically important <b>non-Big-Four</b> species. That distinction is the whole point of this map.</div>
