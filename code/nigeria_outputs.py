...
<footer>PANAF-Premium recommended (WHO risk-benefit-assessed, broad, heat-stable/lyophilised — deployable without cold chain). Impact anchored to Habib 2015 (Nigerian cost-effectiveness). Facilities Maina/WHO; population afripop distribution → 206.1 M; incidence facility-anchored and conservative ({A['implied_national_envenoming_rate_per_100k']}/100k vs published {A['published_west_africa_rate_range_per_100k'][0]}–{A['published_west_africa_rate_range_per_100k'][1]}/100k). Not clinical guidance.</footer></div>
