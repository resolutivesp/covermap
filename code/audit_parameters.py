...
P=[
 ...
 ("india","published sub-national anchors","CITED","68.4% clinical ASV non-response in NW India (Gopalakrishnan 2025, 63/92); 66.19% non-Big-Four share of identified venomous bites in Assam (Menon 2025); Bharat ASV 0.151 mg/ml vs N. sagittifera in the Andamans, a species outside its Big-Four label — a coverage gap, not a failed claim (Attarde 2021); 15.4% Hypnale share of Kerala cases with species known (Menon 2025; an earlier audit line re-based this to 32.6%, which the source does not state).","the hard evidence the case rests on"),
